...
function Home() {
  ...
  useEffect(() => {
    axios.post(url + 'vendors/requests', {}).then(resp => {
      setState({ ...state, requests: resp?.data?.data })
    })
  }, [])
  ...
  const deleteItemConfirm = (i) => {
    ...
    axios.post(url + 'vendors/delete/' + state.deleteRef._id, {}, {
      headers: {
      ...
      if (resp.data.status != 'error') {
        axios.post(url + 'vendors/requests', {}).then(resp => {
          setState({ ...state, requests: resp?.data?.data, deleteRef: null, showDeleteModal: false, })
          ...
          <div className='main-area'>
            ...
            <div className='working-area'>
              ...
              <div className='row'>
                ...
                {state.requests && state.requests.length ? <div class="table-responsive">

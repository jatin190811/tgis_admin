...
function Home() {
  ...
  useEffect(() => {
    axios.post(url + 'venues', {}).then(resp => {
  ...
  const deleteItemConfirm = (i) => {
    ...
    axios.post(url + 'venue/delete/' + state.deleteRef._id, {}, {
      headers: {
  ...
  useEffect(() => {
    axios.post(url + 'venues?page='+state.page, {}).then(resp => {
      setState({ ...state, venues: resp?.data?.data, venuesShow: resp?.data?.data, searchKey: '' })
    })
            ...
            <div className='working-area'>
              ...
              <div className='row'>
                <div className='col-12'>
                  <button onClick={()=>navigate('/venue/add')} className='btn btn-primary pull-right'>Add New</button><br /><br />
                </div>
                <div className='row'>
                              ...
                              <td>
                                <button className='btn btn-primary btn-sm' onClick={() => {
                                 ...
                                 <button className='btn btn-warning btn-sm' onClick={() => {
                                  navigate('/venue/update/' + item._id)
                                }}>Update</button>&nbsp;
                                <button className='btn btn-warning btn-sm' onClick={() => {
                                  navigate('/venue/media/' + item._id)
                                }}>Media</button>&nbsp;

...
function Home() {
  ...
  useEffect(() => {
    axios.post(url + 'groom', {}).then(resp => {
      setState({ ...state, groom_wears: resp?.data?.data })
    })
  }, [])
  ...
  const deleteItemConfirm = (i) => {
    ...
    axios.post(url + 'groom/delete/' + state.deleteRef._id, {}, {
      ...
      if (resp.data.status != 'error') {
        axios.post(url + 'groom', {}).then(resp => {
          setState({ ...state, groom_wears: resp?.data?.data,  deleteRef: null, showDeleteModal: false, })
          ...
          <div className='main-area'>
            ...
            <div className='working-area'>
              ...
              <div className='row'>
                ...
                {state.groom_wears && state.groom_wears.length ? <div class="table-responsive">
                  ...
                  <table class="table table-hover table-bordered table table-striped">
                    ...
                    <tbody>
                      {
                        state.groom_wears.map((item, index) => {
                          return (
                            <tr>
                              <td>{item.name}</td>
                              <td>{item.type}</td>
